        ...
        <Box id="service" sx={{ background: '#1f2623', color: '#fff', padding: { xs: '50px', md: '80px' }, pt:{xs: '50px', md: '150px'} }}>
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={3}>
                    ...
                    <Typography sx={{ fontWeight: '700', mt: '10px' }}>{t('strategy')}</Typography>
                </Grid>
                <Grid item xs={12} md={3}>
                    <img width="100%" src={img2} />
                    <Typography sx={{ fontWeight: '700', mt: '10px' }}>{t('Training')}</Typography>
                </Grid>
                <Grid item xs={12} md={3}>
                    <img width="100%" src={img2} />
                    <Typography sx={{ fontWeight: '700', mt: '10px' }}>{t('Compensation')}</Typography>
                </Grid>
                <Grid item xs={12} md={3}>
                    <img width="100%" src={img1} />
                    <Typography sx={{ fontWeight: '700', mt: '10px' }}>{t('Process')}</Typography>
                </Grid>
            </Grid>
        </Box>
    )
