            ...
            <Grid container alignItems="center">
                <Grid item container xs={12} md={6} spacing={1}>
                    ...
                    <Grid item xs={12} md={5} sx={{ padding: { xs: '0px', md: '20px' }, mt: { xs: '0px', md: '-15px' } }}>
                        <Box sx={{ width: { xs: '93%', md: '100%' } }}>
                            <input value={name} onChange={e => setName(e.target.value)} className="inputForm fontPlaceholder" type="text" name="тфьу" placeholder={t('Name')} />
                        </Box>
                    </Grid>
                    <Grid sx={{ padding: { xs: '0px', md: '20px' }, mt: { xs: '0px', md: '-15px' } }} item xs={12} md={5}>
                        <Box sx={{ width: { xs: '93%', md: '100%' } }}>
                            <input value={company} onChange={e => setCompany(e.target.value)} className="inputForm fontPlaceholder" type="text" name="сompany" placeholder={t('Company')} />
                        </Box>
                    </Grid>
                    ...
                    <Grid sx={{ padding: { xs: '0px', md: '20px' }, mt: { xs: '0px', md: '-15px' } }} item xs={12} md={5}>
                        <Box sx={{ width: { xs: '93%', md: '100%' } }}>
                            <input value={country} onChange={e => setCountry(e.target.value)} className="inputForm fontPlaceholder" type="text" name="country" placeholder={t('Country')} />
                        </Box>
                    </Grid>
